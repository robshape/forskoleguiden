...
Step 2.1 (Swedish i18n contract) and Step 2.2 (placeholder locales) are complete with green quality gates, and Step 2 i18n foundation remains in progress.
...
- Step 2.3 and subtask 6.4 are still pending.

Pending tracked tasks:

- `TASK006` (in progress, next focus): complete Step 2.3 locale helpers/utilities and subtask 6.4 helper behavior tests.
...
Next implementation focus: finish Step 2.3 within `TASK006` (plus subtask 6.4) to unblock Step 3.1-3.3. Step 3.4 redirect remains independently implementable and tracked as deferred.
