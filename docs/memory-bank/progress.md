...
1. **Step 9.3** — render deterministic comparison summary text on the comparison page.

## Next Focus

- Step 9.3 summary text rendering in `ComparisonView` plus e2e coverage.
