...
Current status (2026-03-01): Steps 0.5 through 0.11, Steps 1.1-1.5, and Step 2.1 are complete with green quality gates.
...
1. **Step 2 i18n foundation** (`TASK006`) — in progress; Step 2.1 complete, with Step 2.2/2.3 pending as next focus.
...
Complete Step 2.2 and Step 2.3 for i18n foundation (`TASK006`), then unblock Step 3.1-3.3 route/layout work.
